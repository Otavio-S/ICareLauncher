...
public class CamposHistorico {
    ...
    public static final String COLUNA_DATA_INICIAL = "historico_data_inicial";
    public static final String COLUNA_DATA_FINAL = "historico_data_final";
    public static final String COLUNA_HORA_INICIAL = "historico_hora_inicial";
